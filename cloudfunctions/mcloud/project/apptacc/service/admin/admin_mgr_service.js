...
class AdminMgrService extends BaseProjectAdminService {
	...
	async adminLogin(name, password) {
		...
		let fields = 'ADMIN_UNIT_NAME,ADMIN_UNIT_ID,ADMIN_ID,ADMIN_NAME,ADMIN_DESC,ADMIN_TYPE,ADMIN_LOGIN_TIME,ADMIN_LOGIN_CNT';
		...
		return {
			...
			last,
			cnt,
			unit: admin.ADMIN_UNIT_NAME,
			unitId: admin.ADMIN_UNIT_ID
		}
	...
	async getMgrList({
		...
		let fields = 'ADMIN_UNIT_NAME,ADMIN_NAME,ADMIN_STATUS,ADMIN_PHONE,ADMIN_TYPE,ADMIN_LOGIN_CNT,ADMIN_LOGIN_TIME,ADMIN_DESC,ADMIN_EDIT_TIME,ADMIN_EDIT_IP';
