...
module.exports = {
	...
	// 单元
	// 分类 
	'unit/all_options': 'unit_controller@getAllUnitOptions',

	'admin/unit_list': 'admin/admin_unit_controller@getAdminUnitList',
	'admin/unit_insert': 'admin/admin_unit_controller@insertUnit#demo',
	'admin/unit_del': 'admin/admin_unit_controller@delUnit#demo',
	'admin/unit_detail': 'admin/admin_unit_controller@getUnitDetail',
	'admin/unit_edit': 'admin/admin_unit_controller@editUnit#demo',
	'admin/unit_status': 'admin/admin_unit_controller@statusUnit#demo',
	'admin/unit_sort': 'admin/admin_unit_controller@sortUnit#demo',
	'admin/unit_update_forms': 'admin/admin_unit_controller@updateUnitForms#demo',
