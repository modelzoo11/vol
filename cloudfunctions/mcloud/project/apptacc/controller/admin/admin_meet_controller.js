...
class AdminMeetController extends BaseProjectAdminController {
	...
	async scanJoin() {
		...
		let service = new AdminMeetService();
		await service.scanJoin(this._admin, input.meetId, input.code);
	}
	...
	async getAdminMeetList() {
		...
		let service = new AdminMeetService();
		let result = await service.getAdminMeetList(this._admin, input);
	...
	async insertMeetTemp() {
		...
		let service = new AdminMeetService();
		let result = await service.insertMeetTemp(this._admin, input, 'admin');
	...
	async getMeetTempList() {
		...
		let service = new AdminMeetService();
		let result = await service.getMeetTempList(this._admin, 'admin');
	...
	async joinDataExport() {
		...
		let service = new AdminMeetService();
		return await service.exportJoinDataExcel(this._admin, input);
	}
